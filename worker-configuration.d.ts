/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 1d13cba291395b2c2de55bf35542e663)
// Runtime types generated with workerd@1.20251217.0 2025-12-21 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "WorkflowObject";
	}
	interface Env {
		WORKFLOW_OBJECT: DurableObjectNamespace<import("./src/index").WorkflowObject>;
		RELAY_WORKFLOW: Workflow<Parameters<import("./src/index").RelayWorkflow['run']>[0]['payload']>;
	}
}
